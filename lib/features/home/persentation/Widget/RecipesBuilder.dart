...
class RecipesBuilder extends StatelessWidget {
  ...
  RecipesBuilder({required this.meal});
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              CircleAvatar(
                radius: 30,
                backgroundImage: meal.image.isNotEmpty
                    ...
                    Row(
                      children: [
                        Text(
                          ...
                          style: AppTextStyles.style_med_15
                              .copyWith(color: AppColors.c_8A8A8A),
                        ),
                        SizedBox(width: 10),
                        Text(
                          '${meal.duration} min',
